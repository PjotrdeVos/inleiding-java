...
public class PraktijkH112 extends Applet{
    TextField Cijfer1;
    Button Enter;
    int Getal1,Uitkomst;
    ...
    public void paint (Graphics g) {
        ...
        g.drawString(Getal1 + "x1=" + Getal1 * 1 +"" ,100,20);
        g.drawString(Getal1 + "x2=" + Getal1 * 2 +"" ,100,50);
        g.drawString(Getal1 + "x3=" + Getal1 * 3 +"" ,100,80);
        g.drawString(Getal1 + "x4=" + Getal1 * 4 +"" ,100,110);
        g.drawString(Getal1 + "x5=" + Getal1 * 5 +"" ,100,140);
        g.drawString(Getal1 + "x6=" + Getal1 * 6 +"" ,100,170);
        g.drawString(Getal1 + "x7=" + Getal1 * 7 +"" ,100,200);
        g.drawString(Getal1 + "x8=" + Getal1 * 8 +"" ,100,230);
        g.drawString(Getal1 + "x9=" + Getal1 * 9 +"" ,100,260);
        g.drawString(Getal1 + "x10=" + Getal1 * 10 +"" ,100,290);
